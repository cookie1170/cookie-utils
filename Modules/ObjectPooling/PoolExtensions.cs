...
namespace CookieUtils.ObjectPooling
{
    ...
    public static class PoolExtensions
    {
        ...
        public static T Get<T>(this T prefab, Vector3 position) where T : Component => PoolManager.Inst
            .GetObject(prefab.gameObject, position, Quaternion.identity).GetComponent<T>();
        ...
        public static GameObject Get(this GameObject prefab) => Get(prefab, Vector3.zero, Quaternion.identity);
        ...
        public static bool Release(this GameObject obj) => PoolManager.Inst && PoolManager.Inst.Release(obj);
