...
namespace CookieUtils.Debugging
{
    ...
    internal class UGUIDebugUI_Builder : IDebugUI_If
    {
        ...
        {
            var field = Object.Instantiate<DebugUI_StringField>(
                UGUIDebugUI_Helper.StringFieldPrefab
            );
            field.Init(text, updateValue, onValueEdited);
            Add(field);
        }
        ...
        {
            var field = Object.Instantiate<DebugUI_Vector2Field>(
                UGUIDebugUI_Helper.Vector2FieldPrefab
            );
        ...
        {
            var field = Object.Instantiate<DebugUI_Vector3Field>(
                UGUIDebugUI_Helper.Vector3FieldPrefab
            );
        ...
        {
            var foldout = Object.Instantiate<DebugUI_FoldoutGroup>(
                UGUIDebugUI_Helper.FoldoutGroupPrefab
            );
        ...
        {
            var group = Object
                .Instantiate<GameObject>(UGUIDebugUI_Helper.GroupPrefab)
                .AddComponent<DebugUI_IfGroup>();
